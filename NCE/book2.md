...
在每一个单元的中间（11、12）和末尾（23、24）会有复习的文章
...
hand
n 手 (表或机器的)指针 hour/minute/second hand
v 传递 hand sb to sth
...
be proud of sb/sth
以...为自豪
His family are proud of his success
...
去某个地方迎接某人
...will be meeting them at the station.   13
...
Neither you nor Jack is the right person for the job.
...
As everyone knows,Jim is a nice.
正如每个人都知道的那样...
```
...
```
真实条件状语从句：可能发生的，如：如果你停车...
非真实条件状语从句：不可能发生的，如：如果我是你...

if 引导的真实条件句表将来的情况，主句用 一般将来时（will do）或者 情态词 ，从句用一般现在时（主将从现）

If they are not brought to the surface they may lose their lives. 88

If explosives are used, vibrations will cause the roof of the mine to collapse. 88
...
one
指代每个人 任何人
One who comes to China never fails to visit Beijing.
...
第10课
1.表示状态的动词通常不用在被动语态中
如：have\fit\cost\lack\possess\belong to
2.不及物动词不用于被动语态
3.动词的宾语是不定式或动名词，通常不能变为被动语态
...
进行时与频度副词always、constantly等连用，表示夸奖、埋怨、不满等感情
