...
在英语中，当特殊疑问句（即以 疑问词 开头的句子，如 what, where, how 等）中加入 插入语（如 do you suppose, do you think, do you believe） 时，句子的语序会发生变化，从 疑问句语序 变为 陈述句语序。插入语（do you suppose）本身已经是一个疑问结构（助动词 do + 主语 you + 动词 suppose），所以后面的部分不再需要倒装。
